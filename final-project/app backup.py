...
def courses(categories):
    ...
    if "all" in selected_categories:
        ...
        session["filtered-topics"] = {
            category: topics_data[category] for category in selected_categories
        }
...
def courses_specific():
    ...
    if user_data["status"] != "student":
        ...
        prerequisite in user_courses_finished for prerequisite in dependencies
    ):
